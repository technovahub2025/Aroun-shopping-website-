...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-r from-red-50 via-white to-red-50 overflow-hidden">
      {/* Decorative shapes */}
      <div className="absolute -top-32 -left-32 w-96 h-96 bg-red-200 rounded-full mix-blend-multiply opacity-30 animate-pulse"></div>
      <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-red-300 rounded-full mix-blend-multiply opacity-30 animate-pulse"></div>
      ...
      <div className="max-w-7xl  mx-auto px-4 md:px-10 py-20 md:py-32 flex flex-col-reverse md:flex-row items-center gap-10 relative z-10">
        ...
        <div className="flex-1 text-center md:text-left space-y-6">
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 leading-tight">
            Discover <span className="text-red-500">Amazing Products</span>
          </h1>
          ...
          <div className="flex justify-center md:justify-start gap-4 mt-6">
            <button className="bg-red-500 text-white px-7 py-3 rounded-full font-semibold shadow-lg hover:bg-red-600 transform hover:scale-105 transition">
              Shop Now
            </button>
